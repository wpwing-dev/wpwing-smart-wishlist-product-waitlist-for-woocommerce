...
class Settings {
	...
	public static function email_subject_template(): string {
		...
		return \__( '[{store_name}] "{product_name}" is back in stock', 'wpwing-smart-wishlist-product-waitlist-for-woocommerce' );
	}
	...
	public static function email_body_template(): string {
		...
		$intro       = \__( 'Good news! "{product_name}" is back in stock.', 'wpwing-smart-wishlist-product-waitlist-for-woocommerce' );
		$shop_now    = \__( 'Shop now', 'wpwing-smart-wishlist-product-waitlist-for-woocommerce' );
		$unsubscribe = \__( 'Unsubscribe from this notification', 'wpwing-smart-wishlist-product-waitlist-for-woocommerce' );
		return '<p>' . $intro . '</p>'
