...
class AdminWishlist {
	...
	public function render_page(): void {
		...
		?>
		<div class="wrap">
			<h1 class="wp-heading-inline"><?php esc_html_e( 'Wishlist', 'wpwing-wishlist-and-waitlist-for-woocommerce' ); ?></h1>
				...
				<table class="wp-list-table widefat fixed striped">
					<thead>
						<tr>
							...
							<th><?php esc_html_e( 'User', 'wpwing-wishlist-and-waitlist-for-woocommerce' ); ?></th>
							<th><?php esc_html_e( 'Product', 'wpwing-wishlist-and-waitlist-for-woocommerce' ); ?></th>
							<th><?php esc_html_e( 'Added', 'wpwing-wishlist-and-waitlist-for-woocommerce' ); ?></th>
						</tr>
					</thead>
					<tbody>
						<?php if ( $entries ) : ?>
								...
								if ( $entry->user_id ) {
									...
									$user_label = $wp_user
										...
										: sprintf(
											...
											__( 'User #%d', 'wpwing-wishlist-and-waitlist-for-woocommerce' ),
											(int) $entry->user_id
										);
									$user_url = $wp_user ? get_edit_user_link( (int) $entry->user_id ) : '';
								} else {
									$user_label = __( 'Guest', 'wpwing-wishlist-and-waitlist-for-woocommerce' );
									$user_url   = '';
								}
						...
						<?php else : ?>
							<tr>
								<td colspan="5"><?php esc_html_e( 'No wishlist entries yet.', 'wpwing-wishlist-and-waitlist-for-woocommerce' ); ?></td>
							</tr>
						<?php endif; ?>
					</tbody>
				</table>
